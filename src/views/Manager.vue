      ...
      <div class="manager-main-left">
        <el-menu :default-openeds="['info', 'user']" router style="border: none" :default-active="$route.path">
          ...
          <el-submenu index="info">
            ...
            <el-menu-item index="/department" v-if="user.role=='ADMIN'">部门信息</el-menu-item>
          ...
          <el-submenu index="integration" v-if="user.role=='ADMIN'">
            <template slot="title">
              <i class="el-icon-connection"></i><span>集成管理</span>
            </template>
            <el-menu-item index="/integration">企业微信/钉钉集成</el-menu-item>
          </el-submenu>
        </el-menu>
      </div>
